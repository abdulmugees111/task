...
import { HomeIcon, SearchIcon, ShoppingCartIcon, UserIcon, ChatIcon, BellIcon, CalendarIcon } from '@heroicons/react/solid';
import "../../style.css"
const SideMenu: React.FC = () => {
  return (
    <aside className="bg-gray-800 text-white w-20 ">
        <div className='custBG'>
 <div className="interCont flex flex-col  h-full space-y-4 w-full justify-center items-center">
